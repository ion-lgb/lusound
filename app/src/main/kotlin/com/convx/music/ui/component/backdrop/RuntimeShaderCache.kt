...
internal class RuntimeShaderCacheImpl : RuntimeShaderCache {
    ...
    override fun obtainRuntimeShader(key: String, string: String): RuntimeShader {
        // LuSound: reject unsupported calls explicitly before constructing an API33 shader.
        if (!isRuntimeShaderSupported()) throw UnsupportedOperationException("Runtime shaders require Android 13 or later")
