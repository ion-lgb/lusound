...
fun FloatingTabBar(
    ...
    // All resting states intentionally have zero blur; the keyframes supply the pulse.
...
private fun SharedTransitionScope.InlineStandaloneTab(
    ...
    Tab(
        ...
        modifier = modifier
            ...
            .then(glow.modifier)
            .testTag("nav_${standaloneTab.key}")
            .tapClickable(
            ...
            allTabs.forEachIndexed { index, tab ->
                Tab(
                    ...
                    modifier = Modifier
                        ...
                        .testTag("nav_${tab.key}")
                        .semantics { selected = tab.key == selectedTabKey }
                        .tapClickable(
